...
export default function AdminSidebar() {
  ...
  return (
    <aside className="w-56 shrink-0 flex flex-col"
      style={{ background: '#1a1a2e', borderRight: '1px solid rgba(255,255,255,0.055)', minHeight: '100vh' }}>

      {/* Logo */}
      <div className="px-5 py-6" style={{ borderBottom: '1px solid rgba(255,255,255,0.055)' }}>
        <p className="text-xs font-black uppercase tracking-widest mb-0.5" style={{ color: 'rgba(255,255,255,0.3)' }}>Panel</p>
        ...
        {NAV.map(item => {
          ...
          return (
            <Link key={item.href} href={item.href}
              ...
              style={active
                ? { background: 'rgba(232,197,71,0.15)', color: '#E8C547', border: '1px solid rgba(232,197,71,0.2)' }
