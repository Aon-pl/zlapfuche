  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <h1 className="text-3xl font-black text-white" style={{ letterSpacing: '-0.02em' }}>Statystyki</h1>
      </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        {[
          ...
          <div key={s.label} className="glass-card-dark p-5">
      ...
      <div className="grid lg:grid-cols-2 gap-6">
        ...
        <div className="glass-card-dark p-5">
          <h2 className="font-black text-white/80 text-sm mb-4">Ostatnio zarejestrowani</h2>
        ...
        {/* Recent offers */}
        <div className="glass-card-dark p-5">
          <h2 className="font-black text-white/80 text-sm mb-4">Ostatnio dodane oferty</h2>
          <div className="space-y-2">
            {recentOffers.map(o => {
              ...
              return (
                <div key={o.id} className="flex items-center justify-between py-2 border-b border-white/5">
                  <div className="min-w-0">
                    <p className="text-sm font-semibold text-white/90 truncate">{o.title}</p>
                    <p className="text-xs text-white/40 truncate">{author} · {o.city}</p>
                  </div>
